const model = {
    ...
    data: {
        ...
        accounts: [
            ...
            { id: 2, name: 'Tom', password: 'passord', userType: 'student', email: 'student1@mail.com', gitHub: 'github.com/dummyaccount1/', pic: 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcS-Pqhsyl0AMubS8TOtQ-obqHiDb2NfeqnKxw&usqp=CAU', cv: 'cv.com/cv', counter: 45, importantInfo: 'B menneske', interests: 'fiske', address: 'Amtmann Michelets vei 5', location: "Vestfold og Telemark" },
            { id: 3, name: 'Meny', password: 'passord', userType: 'company', email: 'bedrift1@mail.com', orgNr: '010010001' },
